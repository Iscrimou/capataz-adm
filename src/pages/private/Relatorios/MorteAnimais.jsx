...
export default function MorteAnimais() {
  ...
  const data = [
    { id: 1, date: '01/02/2023', division: 'Campo 1', description: '1 Vacas Vazias', reason: 'Fraqueza' },
    { id: 2, date: '10/02/2023', division: 'Campo 1', description: '2 Bois', reason: 'Raio' },
    { id: 3, date: '12/02/2023', division: 'Campo Fundo ', description: '2 Vacas Vazias', reason: 'Furto' }
  ];
