...
import DatatableCompraAnimais from "../../../components/CompraAnimais/DatatableCompraAnimais";

export default function CompraAnimais() {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="mt-6 flex flex-col bg-white p-2 shadow-lg">
        ...
        <DatatableCompraAnimais data={data} columns={columns} />
      </div>
    </div>
  );
}